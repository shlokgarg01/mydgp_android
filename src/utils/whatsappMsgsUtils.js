...
export const sendWhatsappUploadWorkUrl = async ({ phoneNumber, bookingId, serviceProviderName,workUrl,startPhotoNumber }) => {
  const url = 'https://graph.facebook.com/v19.0/365577786631719/messages';
  const requestBody = {
    messaging_product: "whatsapp",
    to: phoneNumber,
    type: "template",
    template: {
      name: "new_upload_photos_sned_rider",
      language: {
        code: "en"
      },
      components: [
